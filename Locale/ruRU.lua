...
L["help_askpug"]         = " — попросить игроков без аддона прислать резервы в ЛС"
...
-- Stats / export
L["stats_empty"]         = "В истории лута пока пусто."
L["stats_period_all"]    = "Всё время"
L["stats_period_30"]     = "30 дней"
L["stats_period_7"]      = "7 дней"
L["stats_raid_all"]      = "Все рейды"
L["stats_col_player"]    = "Игрок"
L["stats_col_count"]     = "Кол-во"
L["stats_col_last"]      = "Последний предмет"
L["stats_col_date"]      = "Когда"
L["btn_copy_export"]     = "Копировать"
L["export_title"]        = "Экспорт"
L["export_title_stats"]  = "Статистика лута — экспорт"
L["export_title_loot"]   = "История лута — экспорт"
L["export_hint"]         = "Нажми внутри текста, потом Ctrl+A → Ctrl+C. Готово для вставки в Discord (код-блок ``` ... ```)."
L["player_history_title"] = "История игрока"
